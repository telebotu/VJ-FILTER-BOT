...
# Bot information
SESSION = environ.get('SESSION', 'Yaduhhhh')
API_ID = int(environ.get('API_ID', '23659063'))
API_HASH = environ.get('API_HASH', 'f3b6b069c202bcf984ca8b0df252a57e')
BOT_TOKEN = environ.get('BOT_TOKEN', "6750431129:AAEDw6VYyKzmQslpPtA70qUEYenc30HvHRo")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002177499848'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7143731074').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002165961414').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002103642553') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://johnysins:Meetyadu666@123@johnysins.5n0ifzz.mongodb.net/?retryWrites=true&w=majority&appName=Johnysins")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'yadusins') # owner username without @
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'VMWhcpHgwJMaLFxcjB3wfkQps123')
